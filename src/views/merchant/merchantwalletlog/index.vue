<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="码商ID" align="center" prop="merchantId" show-overflow-tooltip />
      <el-table-column label="码商名称" align="center" prop="merchantName" show-overflow-tooltip />
